...
loc_output_tweets = "C:\\Users\\dwoo57\\Google Drive\\Career\\Projects\\Trending Topics\\Scipts\\Analysis\\Cluster_Trends_0111_to_0125_2_week\\test_NONtrending_topics_end_time.csv"
...
def OpenListOfFilesAppendTopic(inputfilelist,outputfile):
    ...
    ##                 topic_dic[topic] = start_time
        ...
        print "Completed File number:%s" % str(counter)
...
def main():
    ...
    OpenListOfFilesAppendTopic(loc_input_tweets_list,loc_output_tweets)
    pass
