...
topicsInputFilePath = "C:\\Users\\dwoo57\\Google Drive\\Career\\Projects\\Trending Topics\\Scipts\\Analysis\\Cluster_Trends_0111_to_0125_2_week\\test_NONtrending_topics_end_time_double_quotes_rmv.csv"
topicindex = 0
startdateindex = 1

ListOftweetsInputFilePath = [
"C:\\Users\\dwoo57\\Google Drive\\Career\\Projects\\Trending Topics\\Scipts\\Analysis\\Cluster_Trends_0111_to_0119_1week\\test_NONtrending_tweets_015_0111_to_0119_cleaned_step3_reformat_datetime.csv",
"C:\\Users\\dwoo57\\Google Drive\\Career\\Projects\\Trending Topics\\Scipts\\Analysis\\Cluster_Trends_0111_to_0125_2_week\\1_Clean_Format_Raw_Data\\test_NONtrending_tweets_2015_0120_to_0125_cleaned_step3_reformat_datetime.csv"]

#tweetsInputFilePath = "C:\\Users\\dwoo57\\Google Drive\\Career\\Projects\\Trending Topics\\Scipts\\Analysis\\Cluster_Trends_0111_to_0119_1week\\test_NONtrending_tweets_015_0111_to_0119_cleaned_step3_reformat_datetime.csv"

tweetsOutputFilePath = "C:\\Users\\dwoo57\\Google Drive\\Career\\Projects\\Trending Topics\\Scipts\\Analysis\\Cluster_Trends_0111_to_0125_2_week\\Output_tweets_interval_rates_NONtrending_topics_2015_0111_to_0125_V2.csv"
...
def IterateTweetsAndCountTweets(tweetsInputFilePath,topics):
        ...
        for e, line in enumerate( open(tweetsInputFilePath) ):
            ...
            cur_line_topic = re.sub("[^a-zA-Z]","",cur_line_topic)
            cur_line_topic = cur_line_topic.lower()

            #Bii. Get min starttime of topic
            if cur_line_topic == 'na':
                continue

            #cur_line_topic = "\"" + cur_line_topic + "\""
            topic_trend_start_time = topics[cur_line_topic].rstrip('\n')



            #topics_trend_start_time = helper.ConvertStringToDatetime(topic_trend_start_time,'%m/%d/%Y %H:%M')
            topics_trend_start_time = helper.ConvertStringToDatetime(topic_trend_start_time,'"%Y-%m-%d %H:%M:%S"')
...
def IterateListOfTweetsAndCountTweets(ListOftweetsInputFilePath,topics):
        ...
        for index, tweetsInputFilePath in enumerate(ListOftweetsInputFilePath):
            ...
            #A. First loop through tweet file. This will keep appending to file even with new file
            for e, line in enumerate( open(tweetsInputFilePath) ):
